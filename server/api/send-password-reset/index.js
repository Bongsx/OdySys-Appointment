...
const generatePasswordResetEmail = ({ email, resetLink, userName }) => ({
  ...
  HTMLPart: `
    ...
    resetLink || "Reset link will be provided"
      ...
      <p style="font-size: 14px; color: #6b7280; margin-bottom: 10px;">
        If you have any questions or need assistance, please contact our support team at <a href="mailto:${
          process.env.MAILJET_SENDER_EMAIL
        }" style="color: #3b82f6;">${process.env.MAILJET_SENDER_EMAIL}</a>
      </p>
  ...
  TextPart: `
    ...
    Reset Link: ${resetLink || "Reset link will be provided"}
